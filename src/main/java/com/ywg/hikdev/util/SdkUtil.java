...
public class SdkUtil {
    ...
    public static void initSdk() {
        ...
        String urlWindowsPath = "https://ywg.oss-cn-hangzhou.aliyuncs.com/hik_dev/sdk/hik_sdk_windows.zip";
        String urlLinuxPath = "https://ywg.oss-cn-hangzhou.aliyuncs.com/hik_dev/sdk/hik_sdk_linux.zip";
        if (osInfo.isWindows()) {
